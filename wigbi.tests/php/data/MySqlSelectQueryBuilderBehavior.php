<?php
	...
	class MySqlSelectQueryBuilderBehavior extends UnitTestCase
	{
		...
		public function test_build_shouldHandleMultipleWheres()
		{
			...
			$this->assertEqual($result, "SELECT col1,col2 FROM table WHERE col1='1',col2='2' LIMIT 0,10");
		}
		...
		public function test_build_shouldApplyCustomSkipAndTake()
		{
			...
			$this->assertEqual($result, "SELECT col1,col2 FROM table WHERE col1='1',col2='2' LIMIT 25,100");
		}
	}
