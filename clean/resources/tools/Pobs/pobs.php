...
<HEAD>
    ...
    <STYLE TYPE="text/css">
        body { font-family: Arial, sans serif;font-size:<?php echo ($FontSize+2); ?>pt;  vertical-align: top; }
        td { font-family: Verdana, sans serif;font-size:<?php echo $FontSize; ?>pt;  vertical-align: top; }
    </STYLE>
</HEAD>
<BODY>
<?php
    ...
    $ExcludedLines = array();
    $CopyrightText = isset($CopyrightText) ? trim($CopyrightText) : "";
    ...
    <TABLE CELLPADDING=3 WIDTH=100% CELLSPACING=0 BORDER=0>
        <TR>
            ...
            <TABLE WIDTH=100% CELLPADDING=3 CELLSPACING=0 BORDER=1 BORDERCOLOR=#000000>
                ...
                <TR><TD><?php echo $TimeOut ?></TD></TR>
                <TR><TD BGCOLOR=#E6E6E6 VALIGN=TOP><b>Source Directory</b></TD></TR>
                <TR><TD><INPUT TYPE=TEXT NAME=SourceDir VALUE="<?php echo $SourceDir ?>" SIZE=70></TD></TR>
                <TR><TD BGCOLOR=#E6E6E6 VALIGN=TOP><b>Target Directory</b></TD></TR>
                <TR><TD><INPUT TYPE=TEXT NAME=TargetDir VALUE="<?php echo $TargetDir ?>" SIZE=70></TD></TR>
                ...
                <TR><TD>
                    <TABLE BORDER=0 CELLPADDING=0 CELLSPACING=2>
                        ...
                        <TR><TD valign="bottom">JavaScript (Functions & Variables)</TD><TD WIDTH=10 valign="top">&nbsp;</TD><TD><input type="checkbox" name="ReplaceJS" value="1" checked>&nbsp;&nbsp;<?php echo "+ files with extensions: "; foreach($JSFileExtArray as $Key => $Value ) echo '<b>'.$Value.'</b>,'; ?></TD></TR>-->
						
                        <TR><TD WIDTH=130 valign="bottom">Classes</TD><TD WIDTH=10>&nbsp;</TD><TD><input type="checkbox" name="ReplaceClasses" value="1" ></TD></TR>
                        <TR><TD valign="bottom">Functions</TD><TD WIDTH=10>&nbsp;</TD><TD><input type="checkbox" name="ReplaceFunctions" value="1" ></TD></TR>
                        ...
                        <TR><TD valign="bottom">JavaScript (Functions & Variables)</TD><TD WIDTH=10 valign="top">&nbsp;</TD><TD><input type="checkbox" name="ReplaceJS" value="1" >&nbsp;&nbsp;<?php echo "+ files with extensions: "; foreach($JSFileExtArray as $Key => $Value ) echo '<b>'.$Value.'</b>,'; ?></TD></TR>
                    </TABLE>
                </TD></TR>
                ...
                <TR><TD>
                    <TABLE BORDER=0 CELLPADDING=0 CELLSPACING=2>
                       <TR><TD WIDTH=130 valign="bottom">Comments</TD><TD WIDTH=10>&nbsp;</TD><TD><input type="checkbox" name="RemoveComments" value="1" checked>
                        ...
                        <TR><TD valign="bottom">Returns</TD><TD WIDTH=10>&nbsp;</TD><TD><input type="checkbox" name="ConcatenateLines" value="1" checked></TD></TR>
            ...
            <TABLE CELLPADDING=3 WIDTH=100% CELLSPACING=0 BORDER=1 BORDERCOLOR=#000000>
                ...
                <TR><TD><?php foreach($UdExcFuncArray as $Key => $Value ) echo $Key.': '.$Value.'<br>'; ?></TD></TR>
                <TR><TD BGCOLOR=#E6E6E6 VALIGN=TOP><b>Exclude Constants</b></TD></TR>
                <TR><TD><?php foreach($UdExcConstArray as $Key => $Value ) echo $Key.': '.$Value.'<br>'; ?></TD></TR>
                <TR><TD BGCOLOR=#E6E6E6 VALIGN=TOP><b>Functions returning objects (special handling)</b></TD></TR>
                <TR><TD><?php foreach($StdObjRetFunctionsArray as $Key => $Value ) echo $Key.': '.$Value.'<br>'; ?></TD></TR>
            </TABLE>
            </TD>
            <TD WIDTH=20%>
            <TABLE CELLPADDING=3 WIDTH=100% CELLSPACING=0 BORDER=1 BORDERCOLOR=#000000>
                <TR><TD BGCOLOR=#E6E6E6 VALIGN=TOP><b>Exclude Variables</b></TD></TR>
                <TR><TD><?php foreach($UdExcVarArray as $Key => $Value ) echo $Key.': '.$Value.'<br>'; ?></TD></TR>
                <TR><TD BGCOLOR=#E6E6E6 VALIGN=TOP><b>Exclude Files</b></TD></TR>
                <TR><TD><?php foreach($UdExcFileArray as $Key => $Value ) echo $Key.': '.$Value.'<br>'; ?></TD></TR>
                <TR><TD BGCOLOR=#E6E6E6 VALIGN=TOP><b>Exclude Directories</b></TD></TR>
                <TR><TD><?php foreach($UdExcDirArray as $Key => $Value ) echo $Key.': '.$Value.'<br>'; ?></TD></TR>
            </TABLE>
            </TD>
        </TR>
    </TABLE>
