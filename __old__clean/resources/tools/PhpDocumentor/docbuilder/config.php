...
?></a>
			...
			<td valign="top">
				...
				<!-- [DS]: Added 2010-07-31 -->
				<textarea rows="5" cols="60" name="setting_directory" class="text" title="">
/Users/danielsaidi/Documents/Aptana Studio Workspace/wigbi_1/wigbi_source/php,
/Users/danielsaidi/Documents/Aptana Studio Workspace/wigbi_1/wigbi_source/js_doc
				</textarea>
			</td>
			<td valign="top" class="small">
...
?></a>
			...
			<td valign="top">
				...
				<!-- [DS] Added 2010-07-31 -->
				<input type="text" name="setting_target" size="60" class="text" value="/Users/danielsaidi/Documents/Aptana Studio Workspace/wigbi_1/documentation" />				
			</td>
			<td valign="top" class="small">
		...
		<tr>
			...
			<td valign="top">
				...
				<!-- [DS] Added 2010-07-31 -->
				<textarea cols="60" rows="3" name="setting_output" class="text">HTML:frames:DOM/earthli</textarea>
				<br />
	...
	<div class="tab-page" id="tab_options">
		...
		<tr>
			...
			<td>
				...
				<!-- [DS] Added 2010-07-31 -->
				<input type="text" name="setting_title" size="40" value="Wigbi Documentation" class="text">				
			</td>
			<td class="small">
		...
		<tr>
			...
			<td>
				...
				<!-- [DS] Added 2010-07-31 -->
				<input type="TEXT" name="setting_defaultpackagename" size="40" value="Wigbi" class="text" />
			</td>
			<td class="small">
